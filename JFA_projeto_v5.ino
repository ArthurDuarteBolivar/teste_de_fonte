...
void desliga_fontes_devagar() {
  varificar = 1;
  delayRele = millis();
  Serial.println(timeRele);
  if (delayRele - timeRele > 600) {
    Serial.println("1");
    digitalWrite(rele1, HIGH);
  }
  if (delayRele - timeRele > 1200) {
    digitalWrite(rele2, HIGH);
  }
  if (delayRele - timeRele > 1800) {
    digitalWrite(rele3, HIGH);
  }
  if (delayRele - timeRele > 2400) {
    digitalWrite(rele4, HIGH);
  }
  if (delayRele - timeRele > 3000) {
    digitalWrite(rele5, HIGH);
  }
  if (delayRele - timeRele > 3600) {
    digitalWrite(rele6, HIGH);
  }
  if (delayRele - timeRele > 4200) {
    digitalWrite(rele7, HIGH);
  }
  if (delayRele - timeRele > 4800) {
    digitalWrite(rele8, HIGH);
  }
  if (delayRele - timeRele > 5400) {
    digitalWrite(rele9, HIGH);
  }
  if (delayRele - timeRele > 6000) {
    digitalWrite(rele10, HIGH);
  }
  if (delayRele - timeRele > 6600) {
    digitalWrite(rele11, HIGH);
  }
  if (delayRele - timeRele > 7200) {
    digitalWrite(rele12, HIGH);
  }
  if (delayRele - timeRele > 7800) {
    digitalWrite(rele13, HIGH);
  }
  varificar = 0;
}
